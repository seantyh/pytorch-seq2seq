...
class SupervisedTrainerMInput(object):
    ...
    def _train_batch(self, input_variable, input_aux_variable, input_lengths, target_variable, model, teacher_forcing_ratio):
        loss = self.loss
        # Forward propagation
        decoder_outputs, decoder_hidden, other = model(input_variable, input_aux_variable, input_lengths, target_variable,
